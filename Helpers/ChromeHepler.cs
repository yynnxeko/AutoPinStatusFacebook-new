...
namespace WinFormsApp1.Helpers
{
    public class ChromeHepler
    {
        ...
        public static bool SendKeys(ChromeDriver driver, By by, object text, int index = 0, bool clear = false, int timeout = 3, bool checkDisplayed = true, bool fastMode = false, bool enter = false)
        {
